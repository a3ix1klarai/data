...
SCSFExport scsf_Covariance(SCStudyInterfaceRef sc)
{
	...
	Array_JointArray[sc.Index] = sc.BaseDataIn[Input_InputArray1.GetSubgraphIndex()][sc.Index] * sc.BaseDataIn[Input_InputArray2.GetSubgraphIndex()][sc.Index];
	...
	Subgraph_Covariance[sc.Index] = Array_JointAverage[sc.Index] - Array_Average1[sc.Index] * Array_Average2[sc.Index];
}
