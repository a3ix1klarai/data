		...
		else
		{
			...
			for (int ReferenceIndex = FirstIndex; ReferenceIndex <= BarIndex; ReferenceIndex++)
			{
				...
				else
				{
					...
					Subgraph_BarHighs[ReferenceIndex] = Subgraph_BarCloses[ReferenceIndex - 1] + DifferenceHigh[ReferenceIndex];
					
					Subgraph_BarLows[ReferenceIndex] = Subgraph_BarCloses[ReferenceIndex - 1] + DifferenceLow[ReferenceIndex];
					
					Subgraph_BarCloses[ReferenceIndex - 1] = Subgraph_BarCloses[ReferenceIndex - 1] + (AskVolume[ReferenceIndex] - BidVolume[ReferenceIndex]);
